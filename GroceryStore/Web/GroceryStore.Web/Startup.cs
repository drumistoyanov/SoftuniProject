namespace GroceryStore.Web
{
    ...
    using GroceryStore.Data.Common.Repositories;
    using GroceryStore.Data.Models;
    using GroceryStore.Data.Repositories;
    using GroceryStore.Data.Seeding;
    using GroceryStore.Services.Messaging;
    using GroceryStore.Web.ViewModels.Account;
    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            {
                var dbContext = serviceScope.ServiceProvider.GetRequiredService<GroceryStoreDbContext>();
