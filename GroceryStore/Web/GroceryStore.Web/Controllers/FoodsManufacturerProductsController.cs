...
namespace GroceryStore.Web.Controllers
{
    public class FoodsManufacturerProductsController : BaseKindManufacturerProductsController
    {
        ...
        {
            var model = this.Index(id, page, ControllersConstants.Foods);
        ...
        {
            var model = this.PriceHighLow(id, page, ControllersConstants.Foods);
        ...
        {
            var model = this.PriceLowHigh(id, page, ControllersConstants.Foods);
        ...
        {
            var model = this.DiscountHighLow(id, page, ControllersConstants.Foods);
        ...
        {
            var model = this.DiscountLowHigh(id, page, ControllersConstants.Foods);
